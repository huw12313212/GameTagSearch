...
var URLPrefix = "http://store.steampowered.com";
var URLSearchPrefix = "/search/?snr=1_4_4__12&term=";
var URLPostfix = "";
var WebsiteName ="Steam";
var options = {
    headers: {
...
Steam.SearchTag = function(name,callback)
{
		...
		request(options, function (error, response, body) 
		{
		  ...
		  if (!error && response.statusCode == 200) 
		  {
		  	...
		  	//console.log(body);
		  	var listRow = $('.search_name').parent('a');

		  		if(listRow.length>0)
		  		{
					options.url = $(listRow[0]).attr("href");
